...
<div class="warning"><strong>成本口径：</strong>{html.escape(str(assumptions['important_limit']))}。收入反推重量还会受到仔猪、种猪产品结构影响，因此模型所有假设均保留在 CSV/JSON 中供复核，不应把单一目标价理解为确定性预测。</div>
