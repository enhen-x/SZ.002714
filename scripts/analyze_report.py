...
# Build risk matrix
risks_html="""<tr><td>猪价持续低迷</td><td style='color:#c0392b'>高</td><td>30%</td><td>去产能受阻、需求疲软</td><td>严控仓位、分批建仓</td></tr>
<tr><td>饲料成本反弹</td><td style='color:#e67e22'>中</td><td>20%</td><td>南美天气、汇率贬值</td><td>跟踪豆粕/玉米期货</td></tr>
...
<div class="section">
  ...
  <div class="box-green">
    <p style="margin:0">
      ...
      <b>当前股价：<span style="font-size:18px">{CURRENT_PRICE} 元</span></b>（2026-07-28）&nbsp;|&nbsp;
  ...
  <h3>核心论点</h3>
  <ol>
    <li><b>成本护城河持续加深</b>：完全成本 11.3 元/kg 为上市猪企最低，较行业平均低 1-2 元/kg——在周期低谷意味着比别人少亏、比别人多活。2026H1成本已降至 11.6 元/kg。</li>
    <li><b>周期低谷已近底部</b>：能繁母猪 3780 万头（正常保有量 100.8%），产能去化加速。猪粮比 3.99 为历史最深亏损区，行业性亏损不可能无限持续。</li>
  ...
  <h3>主要风险</h3>
  <p>猪价持续低迷（概率30%）、饲料成本反弹（20%）、疫病复发（15%）、融资环境恶化（10%）、管理层风险（5%）。详见第八部分风险矩阵。</p>
...
<div class="section">
  ...
  <div class="box-red">
    ...
    <p style="margin:0">
      ...
      ② <b>猪价 7 月现首个回升信号</b>（6 月 9.57 → 7 月 10.84 元，环比 +13.3%），但仍处历史最深亏损区（猪粮比 3.99）。<br>
...
<div class="section">
  ...
  <ul>
    ...
    <li><b>关注点</b>：二代接棒过渡期（秦牧原 2024 年起担任副总裁）的治理稳定性。</li>
  </ul>
...
<div class="section">
  ...
  <div class="box-orange">
    <p style="margin:0"><b>期货市场验证</b>：大商所 LH 合约（2026-07-28 收盘）——LH2701=12.70 元/kg。期货隐含 2027H1 均价 ≈ 12.87 元/kg，偏向<b>"基准偏上"</b>情景。期货市场提供了相对独立的定价锚点。</p>
  </div>
...
<div class="section">
  ...
  <div class="box-red">
    <p style="margin:0">
      <b>三重交叉验证结论：</b><br>
      ① 加权模型目标价 38 元 → 当前 39.3 元 = <b>模型合理（+3%）</b><br>
      ② 历史低谷 PE 底线 20.6× → 当前 19.3× = <b style="color:#c0392b">市场定价处于 2021 年以来最低水平</b><br>
      ③ 期货市场隐含 2027H1 ≈ 12.87 元/kg → 偏向基准偏上 = <b>复苏预期温和，尚未定价反转</b><br>
      <b>综合：当前价格处于"模型合理 + 市场便宜"的交汇点。下行有限（历史低谷底价 42 元），上行有周期高峰期权。</b>
    </p>
  </div>
...
<div class="section">
  ...
  <div class="box-green">
    <p style="margin:0">
      ...
      <b>当前股价：</b>{CURRENT_PRICE} 元（2026-07-28）<br>
      <b>12 个月目标价：42 – 49 元</b>（潜在上涨 +7% – +25%）<br>
      <b>目标价推导：</b>历史低谷 PE 底线 21× → 21 × {AVG8_EPS:.2f} = 42 元（底价）；周期均值 PE 24× → 24 × {AVG8_EPS:.2f} = 49 元（合理估值上沿）<br>
      <b>情景分析：</b>若猪价持续低迷（概率 20%）→ 股价或回落至 30-35 元；若猪价如期货预期温和复苏（概率 50%）→ 40-45 元；若猪价反转至 16+ 元/kg（概率 30%）→ 50+ 元
    </p>
  </div>

  <h3>8.2 核心论点（投资逻辑链）</h3>
  <ol>
    <li><b>周期位置有利</b>：猪价处于历史最深亏损区（猪粮比 3.99），能繁母猪去化方向确定。周期型公司的买入时机往往在最悲观时。</li>
    <li><b>成本护城河在低谷期被放大</b>：当全行业亏损时，成本最低者活到最后——2026 年行业性亏损将是牧原市场份额进一步提升的窗口。</li>
    <li><b>估值是最大安全垫</b>：19.3× 周期 PE 低于任何 2021 年以来的低谷。如果历史定价规律成立，当前向下空间有限。</li>
    <li><b>催化剂逐渐积累</b>：能繁持续去化 → 猪价拐点 → 盈利反转——未来 6-12 个月多条催化剂可能兑现。</li>
    <li><b>周期高峰期权是"免费午餐"</b>：以当前估值买入，如果未来 2-3 年内周期回归高峰（猪价 16-20 元/kg），潜在回报 100%+。这不是预测，而是周期必然。</li>
  </ol>
